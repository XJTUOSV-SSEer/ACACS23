...
int judge(std::string a,std::string b);
std::string dezero(std::string a);
std::string minuss(std::string a,std::string b);
std::string mod(std::string a,std::string b);
std::string multiply(std::string a,std::string b);
std::string quickpower(std::string a,std::string b,std::string c);
std::string divide(std::string a,std::string b);
std::string ex_gcd(std::string a,std::string b, std::string &x,std::string &y);
